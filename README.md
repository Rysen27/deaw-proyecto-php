...
- `run.php` → Punto de entrada del proyecto  
- `docs/` → (se generará con phpDocumentor)  
...
3. Documentar y mejorar el código (añadir PHPDoc)  
4. Hacer al menos 3 commits con mensajes claros  
5. Publicar la rama y crear un Pull Request  
6. El propietario revisa, fusiona y genera la documentación final
